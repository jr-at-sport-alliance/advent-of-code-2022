...
import com.adventofcode.day19.exercise1.RobotType.CLAY
import com.adventofcode.day19.exercise1.RobotType.GEODE
import com.adventofcode.day19.exercise1.RobotType.OBSIDIAN
import com.adventofcode.day19.exercise1.RobotType.ORE
...
fun rateFactoryBlueprints(reader: Reader): Int {
    return reader.useLines { lines ->
        ...
        }.map { val a = calculateGeodesMinedForBlueprintViaDecisionTree(it); println(a); it.id * a }.sum()
    }
}
