...
import com.adventofcode.day5.exercise2.InputState.CRATES
import com.adventofcode.day5.exercise2.InputState.CRATE_BASE
import com.adventofcode.day5.exercise2.InputState.CRATE_INSTRUCTION_DIVIDER
import com.adventofcode.day5.exercise2.InputState.INSTRUCTIONS
        ...
        lines.forEach { line ->
            when (inputState) {
                ...
                CRATE_INSTRUCTION_DIVIDER, INSTRUCTIONS -> {
                    ...
                    repeat(count) {
                        tempStack.addFirst(stacks[source - 1].removeFirst())
                    }
                    repeat(count) {
                        stacks[destination - 1].addFirst(tempStack.removeFirst())
                    }
